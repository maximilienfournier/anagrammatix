...
jQuery(function($){    
    ...
    var App = {
        ...
        /**
         * Identifies the number of players in the room
         * Starts at 0
         */
        numPlayersInRoom: 0,
        ...
        Player : {
            ...
            onPlayerStartClick: function() {
                ...
                console.log('checking Playername would be called next');
                console.log(App.Host.numPlayersInRoom);
                // Checks if the playerName already exists
                for (var i = 0; i < App.Host.numPlayersInRoom; i++) {
                    console.log('checking Playername');
                    console.log('player name is (no data)'+playerName);
                    console.log('player name is (data)'+data.playerName);
                    console.log(App.Host.players[i].myName); //bug is here
                    if (playerName === App.Host.players[i].myName){
                        this.emit('error',{message: "This name already exist."} );
                    }
                };
